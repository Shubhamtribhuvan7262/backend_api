async function Mrequest(){
    try {
       let res = await fetch("https://fine-puce-wombat-tux.cyclic.app/Movies/");
...
async function Mrequest1(){
    try {
       let res = await fetch("https://fine-puce-wombat-tux.cyclic.app/Movies/sort/rating");
       let data = await res.json();
       // console.log(data); 
       MoviesAllData(data);
       if (!Array.isArray(data.data)) {
...
async function Mrequest2(){
    try {
       let res = await fetch("https://fine-puce-wombat-tux.cyclic.app/Movies/sort1/rating");
       let data = await res.json();
       // console.log(data); 
       MoviesAllData(data);
       if (!Array.isArray(data.data)) {
...
async function Mrequest5() {
   try {
       let res = await fetch(`https://fine-puce-wombat-tux.cyclic.app/Movies/page/${pagenum}`);
       let data = await res.json();
       console.log(data); 
       MoviesAllData(data);
       if (!Array.isArray(data.data)) {
...
async function Mrequest6(event) {
    ...
    try{
        let res = await fetch(`https://fine-puce-wombat-tux.cyclic.app/Movies/title/${query}`);
        let data = await res.json();
        console.log(data); 
        MoviesAllData(data);
